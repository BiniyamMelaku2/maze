 ...
 * @map: X/Y coordinates of current box of maze
 ...
 * @rayDir: direction of X/Y coordinates of ray position
 * @distToWall: distance to wall from camera
 * @wallX: X position of wall hit by raycaster
 * @drawEnd: end position of drawn wall slice
 * @x: number of raycasted
 * @side: value shows wall is N/S or E/W
 * Return: void
 */
