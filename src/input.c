...
/**
 * input - monitors user input
 * @maze: 2D array maze player world map
 * Return: void
 */
void input(int *maze)
{
	...
	double moveSpeed; /* moving speed modifier */
	double rotateSpeed; /* rotation speed modifier */
...
/**
 * quit - user exit checking
 * Return: True user quits, else False
 */
bool quit(void)
{
